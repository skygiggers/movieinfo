...
public class PopularDataSource extends PageKeyedDataSource<Integer, Result> {
    ...
    private static final String TAG = PopularDataSource.class.getSimpleName();
    ...
    public PopularDataSource(CompositeDisposable compositeDisposable, MoviesController moviesController) {
    ...
    public void loadAfter(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, Result> callback) {
        ...
        compositeDisposable.addAll(
            moviesController.getPopular(params.key).subscribe(
                response -> {
